...
<Callout>
  This function needs to be triggered before a player can open the
  stash.
</Callout>
...
<u>**Example**</u>
<br />
For a use case example on this function check out the written
[Guide](../Guides/stashes) for it.

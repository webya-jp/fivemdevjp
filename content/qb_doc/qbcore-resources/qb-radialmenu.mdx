...
- 類似[qb-メニュー.md](qb-menu.md 'mention')このNUIメニューでは、複数のアクションを実行でき、ジョブに基づいて構成できます。

> [!NOTE]
> このメニューは、player の位置など、さまざまなシナリオに基づいて動作を変更するために大幅に変更できます。

> [!NOTE]
> 最大[フォントオーサム](https://fontawesome.com/)バージョン6.1.1
...
> [!WARNING]
> このメニューを使用する前に、以下の使用例をお読みください。

### 使用例

> [!NOTE]
> 設定を見るのは大変かもしれませんが、このフォーマットを読んでいただければ役に立つはずです。

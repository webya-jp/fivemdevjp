...
- 用途[qb-メニュー.md](qb-menu.md 'mention') そして [qb-input.md](qb-input.md 'mention')オプションとのやり取りを処理する[qb-target.md](qb-target.md 'mention') 統合
- カスタムカーを追加するには、qb-coreのvehicles.luaに追加します。[共有.md](../qb-core/shared.md 'mention')table
...
> \[!INFO]
> 無料ショップはどのプレイヤーでもアクセスできますが、管理ショップは設定されたジョブを持つプレイヤーのみがアクセスできます。

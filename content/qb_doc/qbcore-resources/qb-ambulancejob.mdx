...
* 病院ベッドチェックインシステム（[https://github.com/ElusionPDX/mythic\_hospital](https://github.com/ElusionPDX/mythic_hospital)）
* フルダメージ/出血システム（[https://github.com/ElusionPDX/mythic\_hospital](https://github.com/ElusionPDX/mythic_hospital)）

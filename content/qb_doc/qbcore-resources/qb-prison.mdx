...
* 警察がプレイヤーを一定期間投獄できるようにします。playerが投獄されると、アイテムと職業は剥奪されます。釈放されると、それらのアイテムは返却されます。

> \[!INFO]
> プレイヤーは`gatecrack` そして `electronickit`刑務所から脱出するためのアイテム！
...
* qb-prison/client/prisonbreak.lua にあります

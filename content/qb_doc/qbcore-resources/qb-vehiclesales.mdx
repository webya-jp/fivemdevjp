...
- プレイヤーは自分の車を展示し、他の人が自分の設定した価格で購入できるようにすることができます。
- 機会車両をデータベースに保存し、販売されるか、売り手がvehicleを取り戻すまでそこに保存します。
- プレイヤーは、vehicleの2分の1の価格で車両を売却することができます。[共有.md](../qb-core/shared.md 'mention')

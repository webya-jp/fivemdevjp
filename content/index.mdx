...
<FileTree>
  <FileTree.Folder name="app" defaultOpen>
    <FileTree.Folder
      name={
        <FileTreeLabel type="folder" name="api">
          Useful API
        </FileTreeLabel>
      }
      defaultOpen
    ...
    <FileTree.File
      name={
        <FileTreeLabel type="file" name="layout.tsx">
          Main layout
        </FileTreeLabel>
      }
    />
    <FileTree.File
      name={
        <FileTreeLabel type="file" name="page.tsx">
          Homepage
        </FileTreeLabel>
      }
    />
  ...
  <FileTree.Folder
    name={
      <FileTreeLabel type="folder" name="components">
        Useful components
      </FileTreeLabel>
    }
    defaultOpen
  ...
  <FileTree.Folder name="config" defaultOpen>
    <FileTree.File
      name={
        <FileTreeLabel type="file" name="index.ts">
  ...
  <FileTree.Folder
    name={
      <FileTreeLabel type="folder" name="content">
        MDX docs
      </FileTreeLabel>
    }
    defaultOpen

...
title: サーバーエクスポート
sidebar_label: サーバー
keywords: [qbox, fivem, qbx_core, エクスポート]
description: サーバサイドエクスポートのドキュメント。通知、グループ管理、その他のサーバーサイドユーティリティのために利用可能な関数について学んで下さい。
---
...
::警告
v1.8.0で非推奨。代わりに ox_lib ACE パーミッションを使ってください。
:::

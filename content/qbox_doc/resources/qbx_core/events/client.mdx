...
キーワード\[qbox, fivem, qbx\_core, イベント].
説明このドキュメントはQbox Coreフレームワークのクライアントサイドイベントの包括的なドキュメントを提供します。このドキュメントでは、クライアント上でトリガーされる非ネットワークイベントとネットワークイベントの両方について概説し、その目的、使用方法、関連するデータ構造（タイプ）の詳細を提供します。
--------------------------------------------------------------------------------------------------------------------------------------------------------
...
プレイヤーがログアウトし、qbx\_coreのメモリに存在しなくなったときにトリガーされます。

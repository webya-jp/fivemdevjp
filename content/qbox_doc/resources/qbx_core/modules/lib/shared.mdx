...
説明qbx\_core リソースの共有ライブラリ関数のドキュメント。これらの関数は、文字列操作、数学演算、テーブル処理、車両関連機能のための共通ユーティリティを提供し、クライアントサイドとサーバーサイドの両方で使用することができます。
---------------------------------------------------------------------------------------------------------------------
...
:::info
パターンについての詳細は[`lib.string.random`](https://coxdocs.dev/ox_lib/Modules/String/Shared#stringrandom)from ox\_lib.
:::

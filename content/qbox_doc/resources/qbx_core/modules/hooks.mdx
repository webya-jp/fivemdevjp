...
title: フック
sidebar_label: フック
keywords: [qbox, fivem, qbx_core, モジュール, フック]
description: qbx_core リソースの hooks モジュールのドキュメント。このモジュールはイベントフックを登録、管理する機能を提供し、サードパーティリソースがリソースのコードを直接変更することなく動作を変更できるようにします。
---

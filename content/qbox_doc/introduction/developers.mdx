...
playerが所有するvehicleを生成する場合、vehicleのvehicleidステートバッグはplayer\_vehicles tableのIDに設定する必要があります。これにより、他のリソースは安定した識別子を使用してデータベース内のvehicleの情報を参照できるようになります。
